...
const hljs = (function () {
  ...
  const u = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./; const h = '[a-zA-Z]\\w*'; const d = '[a-zA-Z_]\\w*'; const f = '\\b\\d+(\\.\\d+)?'; const p = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)'; const m = '\\b(0b[01]+)'; const b = { begin: '\\\\[\\s\\S]', relevance: 0 }; const E = {
    className: 'string',
    begin: "'",
    end: "'",
    illegal: '\\n',
  ...
  }; const y = w('//', '$'); const N = w('/\\*', '\\*/'); const R = w('#', '$'); const _ = Object.freeze({
    __proto__: null,
  ...
  function T (e, { plugins: t }) {
    function n (t, n) {
      ...
      compile () {
        ...
        const e = this.regexes.map(e => e[1]); this.matcherRe = n(((e, t = '|') => {
          let n = 0
          return e.map(e => {
            n += 1; const t = n; let i = g(e); let s = ''; for (;i.length > 0;) {
    ...
    return e.classNameAliases = a(e.classNameAliases || {}), (function t (i, r) {
      ...
      if (typeof i.keywords === 'object' && (o = i.keywords.$pattern,
      ...
      i.contains || (i.contains = []), i.contains = [].concat(...i.contains.map(e => (e => (e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map(t => a(e, { variants: null }, t))), e.cachedVariants
        ? e.cachedVariants
        : S(e)
          ? a(e, {
            starts: e.starts ? a(e.starts) : null
          })
          : Object.isFrozen(e) ? a(e) : e))(e === 'self' ? i : e))), i.contains.forEach(e => {
        t(e, l)
    ...
    const t = {
      ...
      render (e) { return e('pre', {}, [e('code', { class: this.className, domProps: { innerHTML: this.highlighted } })]) }
    ...
    'after:highlightElement': ({ el: e, result: t, text: n }) => {
      ...
      a.innerHTML = t.value, t.value = ((e, t, n) => {
        let i = 0; let a = ''; const r = []; function l () {
          ...
          a += '</' + C(e) + '>'
        } function g (e) { (e.event === 'start' ? o : c)(e.node) }
        for (;e.length || t.length;) {
          ...
          if (a += s(n.substring(i, t[0].offset)), i = t[0].offset, t === e) {
            ...
            r.reverse().forEach(o)
          } else t[0].event === 'start' ? r.push(t[0].node) : r.pop(), g(t.splice(0, 1)[0])
        }
    ...
    const t = []; return (function e (n, i) {
      for (let s = n.firstChild; s; s = s.nextSibling) {
        s.nodeType === 3
          ...
          : s.nodeType === 1 && (t.push({ event: 'start', offset: i, node: s }), i = e(s, i), C(s).match(/br|hr|img|input/) || t.push({ event: 'stop', offset: i, node: s }))
      } return i
    }(e, 0)), t
  } const $ = e => {
    console.error(e)
  }; const U = (e, ...t) => { console.log('WARN: ' + e, ...t) }; const z = (e, t) => {
    console.log(`Deprecated as of ${e}. ${t}`)
  }; const K = s; const G = a; const V = Symbol('nomatch')
  return (e => {
    const n = Object.create(null); const s = Object.create(null); const a = []; let r = !0
    const l = /(^(<[^>]+>|\t|)+|\n)/gm; const o = "Could not find the language '{}', did you forget to load/include a language module?"; const g = { disableAutodetect: !0, name: 'Plain text', contains: [] }; let u = {
      ...
      typeof t === 'object'
        ? (s = e,
          n = t.ignoreIllegals, a = t.language, i = void 0)
      ...
      function g () {
        ...
        const n = e[0]; const i = t.substr(e.index); const s = d(R, e, i); if (!s) return V; const a = R
        ...
        if (E = a, a.type === 'begin') {
          return (function (e) {
            const t = e[0]; const n = e.rule; const s = new i(n); const a = [n.__beforeBegin, n['on:begin']]
          ...
          throw e.mode = R, e
        } if (a.type === 'end') { const e = b(a); if (e !== V) return e }
        if (a.type === 'illegal' && l === '') return 1
        if (L > 1e5 && L > 3 * a.index) throw Error('potential infinite loop, way more iterations than matches')
        return M += l, l.length
      } const v = N(e)
      if (!v) throw $(o.replace('{}', e)), Error('Unknown language: "' + e + '"')
      const w = T(v, { plugins: a }); let y = ''; let R = l || w; const _ = {}; const k = new u.__emitter(u); (() => {
        const e = []; for (let t = R; t !== v; t = t.parent)t.className && e.unshift(t.className)
        e.forEach(e => k.openNode(e))
      })(); let M = ''; let O = 0; let A = 0; let L = 0; let I = !1; try {
        for (R.matcher.considerAll(); ;) {
          L++, I ? I = !1 : R.matcher.considerAll(), R.matcher.lastIndex = A
          const e = R.matcher.exec(t); if (!e) break; const n = x(t.substring(A, e.index), e)
          A = e.index + n
        } return x(t.substr(A)), k.closeAllNodes(), k.finalize(), y = k.toHTML(), { relevance: Math.floor(O), value: y, language: e, illegal: !1, emitter: k, top: R }
      } catch (n) {
        if (n.message && n.message.includes('Illegal')) {
          return {
            illegal: !0,
            illegalBy: { msg: n.message, context: t.slice(A - 100, A + 100), mode: n.mode },
            sofar: y,
            relevance: 0,
            value: K(t),
            emitter: k
      ...
      })(e); const s = t.filter(N).filter(k).map(t => f(t, e, !1))
    ...
    function x (e) {
      ...
      const i = t.textContent; const a = n ? d(i, { language: n, ignoreIllegals: !0 }) : p(i)
      M('after:highlightElement', { el: e, result: a, text: i }), e.innerHTML = a.value, ((e, t, n) => {
        const i = t ? s[t] : n
      ...
      document.readyState !== 'loading' ? document.querySelectorAll('pre code').forEach(x) : w = !0
    ...
    typeof window !== 'undefined' && window.addEventListener && window.addEventListener('DOMContentLoaded', () => {
      ...
      fixMarkup: e => {
        ...
        t = e,
        u.tabReplace || u.useBR ? t.replace(l, e => e === '\n' ? u.useBR ? '<br>' : e : u.tabReplace ? e.replace(/\t/g, u.tabReplace) : e) : t
        let t
      },
      highlightElement: x,
      ...
      registerLanguage: (t, i) => {
        ...
        s.name || (s.name = t), n[t] = s, s.rawDefinition = i.bind(null, e), s.aliases && R(s.aliases, { languageName: t })
      },
      ...
      r = !0
    }, e.versionString = '10.7.1'; for (const e in _) typeof _[e] === 'object' && t(_[e])
    return Object.assign(e, _), e.addPlugin(m), e.addPlugin(D), e.addPlugin(E), e
  })({})
}()); typeof exports === 'object' && typeof module !== 'undefined' && (module.exports = hljs); hljs.registerLanguage('plaintext', (() => { 'use strict'; return t => ({ name: 'Plain text', aliases: ['text', 'txt'], disableAutodetect: !0 }) })()); hljs.registerLanguage('bash', (() => {
  'use strict'; function e (...e) {
    return e.map(e => {
      return (s = e) ? typeof s === 'string' ? s : s.source : null; let s
    }).join('')
  } return s => {
    const n = {}; const t = {
      begin: /\$\{/, end: /\}/, contains: ['self', { begin: /:-/, contains: [n] }]
    }; Object.assign(n, {
      className: 'variable', variants: [{ begin: e(/\$[\w\d#@][\w\d_]*/, '(?![\\w\\d])(?![$])') }, t]
    }); const a = { className: 'subst', begin: /\$\(/, end: /\)/, contains: [s.BACKSLASH_ESCAPE] }; const i = {
      begin: /<<-?\s*(?=\w+)/,
      starts: {
    ...
    }; const r = s.SHEBANG({ binary: '(fish|bash|zsh|sh|csh|ksh|tcsh|dash|scsh)', relevance: 10 }); const l = {
      className: 'function',
      begin: /\w[\w\d_]*\s*\(\s*\)\s*\{/,
      returnBegin: !0,
  ...
  'use strict'; return e => {
    const n = '[ \\t\\f]*'; const a = n + '[:=]' + n; const t = '(' + a + '|[ \\t\\f]+)'; const r = '([^\\\\\\W:= \\t\\f\\n]|\\\\.)+'; const s = '([^\\\\:= \\t\\f\\n]|\\\\.)+'; const i = {
      end: t,
      relevance: 0,
      starts: {
      ...
      contains: [e.COMMENT('^\\s*[!#]', '$'), {
        returnBegin: !0,
        variants: [{ begin: r + a, relevance: 1 }, {
          begin: r + '[ \\t\\f]+',
          relevance: 0
        }],
  ...
  'use strict'
  const e = ['as', 'in', 'of', 'if', 'for', 'while', 'finally', 'var', 'new', 'function', 'do', 'return', 'void', 'else', 'break', 'catch', 'instanceof', 'with', 'throw', 'case', 'default', 'try', 'switch', 'continue', 'typeof', 'delete', 'let', 'yield', 'const', 'class', 'debugger', 'async', 'await', 'static', 'import', 'from', 'export', 'extends']; const n = ['true', 'false', 'null', 'undefined', 'NaN', 'Infinity']; const a = [].concat(['setInterval', 'setTimeout', 'clearInterval', 'clearTimeout', 'require', 'exports', 'eval', 'isFinite', 'isNaN', 'parseFloat', 'parseInt', 'decodeURI', 'decodeURIComponent', 'encodeURI', 'encodeURIComponent', 'escape', 'unescape'], ['arguments', 'this', 'super', 'console', 'window', 'document', 'localStorage', 'module', 'global'], ['Intl', 'DataView', 'Number', 'Math', 'Date', 'String', 'RegExp', 'Object', 'Function', 'Boolean', 'Error', 'Symbol', 'Set', 'Map', 'WeakSet', 'WeakMap', 'Proxy', 'Reflect', 'JSON', 'Promise', 'Float64Array', 'Int16Array', 'Int32Array', 'Int8Array', 'Uint16Array', 'Uint32Array', 'Float32Array', 'Array', 'Uint8Array', 'Uint8ClampedArray', 'ArrayBuffer', 'BigInt64Array', 'BigUint64Array', 'BigInt'], ['EvalError', 'InternalError', 'RangeError', 'ReferenceError', 'SyntaxError', 'TypeError', 'URIError'])
  return r => {
    const t = {
    ...
    }; let i; const s = '[A-Za-z$_][0-9A-Za-z$_]*'; const o = {
      className: 'subst', begin: /#\{/, end: /\}/, keywords: t
    }; const c = [r.BINARY_NUMBER_MODE, r.inherit(r.C_NUMBER_MODE, {
      starts: {
        end: '(\\s*/)?',
        relevance: 0
      }
      ...
      }, { begin: /'/, end: /'/, contains: [r.BACKSLASH_ESCAPE] }, { begin: /"""/, end: /"""/, contains: [r.BACKSLASH_ESCAPE, o] }, {
        begin: /"/,
        end: /"/,
      ...
      subLanguage: 'javascript', excludeBegin: !0, excludeEnd: !0, variants: [{ begin: '```', end: '```' }, { begin: '`', end: '`' }]
    }]; o.contains = c
    const l = r.inherit(r.TITLE_MODE, { begin: s }); const d = '(\\(.*\\)\\s*)?\\B[-=]>'; const g = {
      className: 'params',
      begin: '\\([^\\(]',
      returnBegin: !0,
      contains: [{
      ...
      contains: c.concat([r.COMMENT('###', '###'), r.HASH_COMMENT_MODE, {
        ...
        illegal: /[:="\[\]]/,
        contains: [{ beginKeywords: 'extends', endsWithParent: !0, illegal: /[:="\[\]]/, contains: [l] }, l]
  ...
  function a (...n) { return n.map(n => e(n)).join('') } function s (...n) {
    ...
    const t = a(/[A-Z_]/, a('(', /[A-Z0-9_.-]*:/, ')?'), /[A-Z0-9_.-]*/); const i = { className: 'symbol', begin: /&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;/ }; const r = {
      begin: /\s/,
      contains: [{ className: 'meta-keyword', begin: /#?[a-z_][a-z1-9_-]+/, illegal: /\n/ }]
    }; const c = e.inherit(r, { begin: /\(/, end: /\)/ }); const l = e.inherit(e.APOS_STRING_MODE, { className: 'meta-string' }); const g = e.inherit(e.QUOTE_STRING_MODE, { className: 'meta-string' }); const m = {
      endsWithParent: !0,
      illegal: /</,
      relevance: 0,
      ...
      }, e.COMMENT(/<!--/, /-->/, { relevance: 10 }), { begin: /<!\[CDATA\[/, end: /\]\]>/, relevance: 10 }, i, { className: 'meta', begin: /<\?xml/, end: /\?>/, relevance: 10 }, {
        className: 'tag',
        begin: /<style(?=\s|>)/,
        end: />/,
        keywords: { name: 'style' },
  ...
  return a => {
    const n = (e => ({
    ...
    }))(a); const l = o; const s = i; const d = '@[a-z-]+'; const c = {
      className: 'variable',
      ...
      case_insensitive: !0,
      illegal: "[=/|']",
      contains: [a.C_LINE_COMMENT_MODE, a.C_BLOCK_COMMENT_MODE, { className: 'selector-id', begin: '#[A-Za-z0-9_-]+', relevance: 0 }, {
        ...
        className: 'selector-pseudo',
        begin: '::(' + l.join('|') + ')'
      }, c, { begin: /\(/, end: /\)/, contains: [a.CSS_NUMBER_MODE] }, { className: 'attribute', begin: '\\b(' + r.join('|') + ')\\b' }, {
        ...
        contains: [{
          begin: d,
          className: 'keyword'
        }, { begin: /[a-z-]+(?=:)/, className: 'attribute' }, c, a.QUOTE_STRING_MODE, a.APOS_STRING_MODE, n.HEXCOLOR, a.CSS_NUMBER_MODE]
      }]
    }
  }
  ...
  'use strict'; return e => {
    const i = {
      ...
      contains: [i]
    }; const s = { begin: '^' + e.UNDERSCORE_IDENT_RE + '\\s*(?=[:+?]?=)' }; const r = { className: 'section', begin: /^[^\s]+:/, end: /$/, contains: [i] }; return {
      name: 'Makefile',
      aliases: ['mk', 'mak', 'make'],
      keywords: {
        $pattern: /[\w-]+/,
  ...
  'use strict'; function e (e) {
    return ((...e) => e.map(e => (e => e ? typeof e === 'string' ? e : e.source : null)(e)).join(''))('(', e, ')?')
  } return t => {
    const n = t.COMMENT('//', '$', { contains: [{ begin: /\\\n/ }] }); const r = '[a-zA-Z_]\\w*::'; const a = '(decltype\\(auto\\)|' + e(r) + '[a-zA-Z_]\\w*' + e('<[^<>]+>') + ')'; const i = { className: 'keyword', begin: '\\b[a-z\\d_]*_t\\b' }; const s = {
      className: 'string',
      variants: [{
        begin: '(u8?|U|L)?"',
        end: '"',
      ...
      contains: [{ begin: /\\\n/, relevance: 0 }, t.inherit(s, { className: 'meta-string' }), { className: 'meta-string', begin: /<.*?>/ }, n, t.C_BLOCK_COMMENT_MODE]
    }; const l = {
      className: 'title', begin: e(r) + t.IDENT_RE, relevance: 0
    }; const d = e(r) + t.IDENT_RE + '\\s*\\('; const u = {
    ...
    }; const m = [c, i, n, t.C_BLOCK_COMMENT_MODE, o, s]; const p = {
  ...
  'use strict'; function n (...n) {
    return n.map(n => {
      return (e = n) ? typeof e === 'string' ? e : e.source : null; let e
    }).join('')
  } return e => {
    const a = {
      begin: /<\/?[A-Za-z_]/,
      ...
      className: 'emphasis', contains: [], variants: [{ begin: /\*(?!\*)/, end: /\*/ }, { begin: /_(?!_)/, end: /_/, relevance: 0 }]
  ...
  'use strict'; function e (...e) {
    return e.map(e => {
      return (n = e) ? typeof n === 'string' ? n : n.source : null; let n
    }).join('')
  } return n => {
    const a = 'HTTP/(2|1\\.[01])'; const s = {
      className: 'attribute',
      ...
      contains: [{
        ...
        contains: [{
          ...
          excludeBegin: !0,
          excludeEnd: !0
        }, { className: 'meta', begin: a }, { className: 'keyword', begin: '[A-Z]+' }],
        starts: { end: /\b\B/, illegal: /\S/, contains: t }
  ...
  'use strict'; return e => {
    const n = '([ui](8|16|32|64|128|size)|f(32|64))?'; const t = 'drop i8 i16 i32 i64 i128 isize u8 u16 u32 u64 u128 usize f32 f64 str char bool Box Option Result String Vec Copy Send Sized Sync Drop Fn FnMut FnOnce ToOwned Clone Debug PartialEq PartialOrd Eq Ord AsRef AsMut Into From Default Iterator Extend IntoIterator DoubleEndedIterator ExactSizeIterator SliceConcatExt ToString assert! assert_eq! bitflags! bytes! cfg! col! concat! concat_idents! debug_assert! debug_assert_eq! env! panic! file! format! format_args! include_bin! include_str! line! local_data_key! module_path! option_env! print! println! select! stringify! try! unimplemented! unreachable! vec! write! writeln! macro_rules! assert_ne! debug_assert_ne!'
    return {
      name: 'Rust',
      aliases: ['rs'],
      keywords: {
      ...
      illegal: '</',
      contains: [e.C_LINE_COMMENT_MODE, e.COMMENT('/\\*', '\\*/', { contains: ['self'] }), e.inherit(e.QUOTE_STRING_MODE, { begin: /b?"/, illegal: null }), {
  ...
  'use strict'; function e (e) {
    ...
    return e.map(e => {
      return (t = e) ? typeof t === 'string' ? t : t.source : null; let t
    }).join('')
  } return n => {
    const r = n.COMMENT('//', '$', { contains: [{ begin: /\\\n/ }] }); const a = '[a-zA-Z_]\\w*::'; const i = '(decltype\\(auto\\)|' + e(a) + '[a-zA-Z_]\\w*' + e('<[^<>]+>') + ')'; const s = { className: 'keyword', begin: '\\b[a-z\\d_]*_t\\b' }; const c = {
      className: 'string',
      variants: [{
        begin: '(u8?|U|L)?"',
        end: '"',
      ...
      contains: [{ begin: /\\\n/, relevance: 0 }, n.inherit(c, { className: 'meta-string' }), { className: 'meta-string', begin: /<.*?>/ }, r, n.C_BLOCK_COMMENT_MODE]
    }; const d = {
      className: 'title', begin: e(a) + n.IDENT_RE, relevance: 0
    }; const u = e(a) + n.IDENT_RE + '\\s*\\('; const m = {
      keyword: 'int float while private char char8_t char16_t char32_t catch import module export virtual operator sizeof dynamic_cast|10 typedef const_cast|10 const for static_cast|10 union namespace unsigned long volatile static protected bool template mutable if public friend do goto auto void enum else break extern using asm case typeid wchar_t short reinterpret_cast|10 default double register explicit signed typename try this switch continue inline delete alignas alignof constexpr consteval constinit decltype concept co_await co_return co_yield requires noexcept static_assert thread_local restrict final override atomic_bool atomic_char atomic_schar atomic_uchar atomic_short atomic_ushort atomic_int atomic_uint atomic_long atomic_ulong atomic_llong atomic_ullong new throw return and and_eq bitand bitor compl not not_eq or or_eq xor xor_eq',
      ...
      t('(?=', _, ')')))
    }; let _; const g = [p, l, s, r, n.C_BLOCK_COMMENT_MODE, o, c]; const b = {
      variants: [{ begin: /=/, end: /;/ }, { begin: /\(/, end: /\)/ }, { beginKeywords: 'new throw return else', end: /;/ }],
      keywords: m,
      contains: g.concat([{ begin: /\(/, end: /\)/, keywords: m, contains: g.concat(['self']), relevance: 0 }]),
      relevance: 0
    }; const f = {
      className: 'function',
      begin: '(' + i + '[\\*&\\s]+)+' + u,
      ...
      exports: { preprocessor: l, strings: c, keywords: m }
    }
  }
  ...
  'use strict'; return n => {
    ...
    }; const i = [n.C_LINE_COMMENT_MODE, n.C_BLOCK_COMMENT_MODE]; const a = [n.QUOTE_STRING_MODE, n.C_NUMBER_MODE]; const l = { end: ',', endsWithParent: !0, excludeEnd: !0, contains: a, keywords: e }; const t = {
      begin: /\{/,
      end: /\}/,
      contains: [{
        className: 'attr',
  ...
  return a => {
    ...
    g.push(a.C_LINE_COMMENT_MODE, a.C_BLOCK_COMMENT_MODE, b("'"), b('"'), a.CSS_NUMBER_MODE, {
      ...
      beginKeywords: 'when', endsWithParent: !0, contains: [{ beginKeywords: 'and not' }].concat(g)
    }; const w = {
      begin: d + '\\s*:',
      returnBegin: !0,
      end: /[;}]/,
      ...
      className: 'variable', variants: [{ begin: '@[\\w-]+\\s*:', relevance: 15 }, { begin: '@[\\w-]+' }], starts: { end: '[;}]', returnEnd: !0, contains: f }
    }; const k = {
  ...
  'use strict'; return e => ({
    ...
    contains: [{
      ...
      }, { begin: /^index/, end: /$/ }, { begin: /={3,}/, end: /$/ }, { begin: /^-{3}/, end: /$/ }, { begin: /^\*{3} /, end: /$/ }, { begin: /^\+{3}/, end: /$/ }, { begin: /^\*{15}$/ }, { begin: /^diff --git/, end: /$/ }]
    }, { className: 'addition', begin: /^\+/, end: /$/ }, { className: 'deletion', begin: /^-/, end: /$/ }, {
      className: 'addition',
      begin: /^!/,
      end: /$/
    }]
  ...
  return n => {
    ...
    }))(n); const l = [n.APOS_STRING_MODE, n.QUOTE_STRING_MODE]; return {
      name: 'CSS',
      case_insensitive: !0,
      illegal: /[=|'\$]/,
      keywords: { keyframePosition: 'from to' },
      classNameAliases: { keyframePosition: 'selector-tag' },
      contains: [n.C_BLOCK_COMMENT_MODE, { begin: /-(webkit|moz|ms|o)-(?=[a-z])/ }, n.CSS_NUMBER_MODE, { className: 'selector-id', begin: /#[A-Za-z0-9_-]+/, relevance: 0 }, { className: 'selector-class', begin: '\\.[a-zA-Z-][a-zA-Z0-9_-]*', relevance: 0 }, a.ATTRIBUTE_SELECTOR_MODE, {
        className: 'selector-pseudo', variants: [{ begin: ':(' + i.join('|') + ')' }, { begin: '::(' + o.join('|') + ')' }]
      }, { className: 'attribute', begin: '\\b(' + r.join('|') + ')\\b' }, {
        begin: ':',
        end: '[;}]',
        contains: [a.HEXCOLOR, a.IMPORTANT, n.CSS_NUMBER_MODE, ...l, {
          begin: /(url|data-uri)\(/, end: /\)/, relevance: 0, keywords: { built_in: 'url data-uri' }, contains: [{ className: 'string', begin: /[^)]/, endsWithParent: !0, excludeEnd: !0 }]
        }, { className: 'built_in', begin: /[\w-]+(?=\()/ }]
      }, {
        begin: (s = /@/, ((...e) => e.map(e => (e => e ? typeof e === 'string' ? e : e.source : null)(e)).join(''))('(?=', s, ')')),
        end: '[{;]',
        relevance: 0,
        illegal: /:/,
        contains: [{
  ...
  'use strict'
  const e = '[A-Za-z$_][0-9A-Za-z$_]*'; const n = ['as', 'in', 'of', 'if', 'for', 'while', 'finally', 'var', 'new', 'function', 'do', 'return', 'void', 'else', 'break', 'catch', 'instanceof', 'with', 'throw', 'case', 'default', 'try', 'switch', 'continue', 'typeof', 'delete', 'let', 'yield', 'const', 'class', 'debugger', 'async', 'await', 'static', 'import', 'from', 'export', 'extends']; const a = ['true', 'false', 'null', 'undefined', 'NaN', 'Infinity']; const s = [].concat(['setInterval', 'setTimeout', 'clearInterval', 'clearTimeout', 'require', 'exports', 'eval', 'isFinite', 'isNaN', 'parseFloat', 'parseInt', 'decodeURI', 'decodeURIComponent', 'encodeURI', 'encodeURIComponent', 'escape', 'unescape'], ['arguments', 'this', 'super', 'console', 'window', 'document', 'localStorage', 'module', 'global'], ['Intl', 'DataView', 'Number', 'Math', 'Date', 'String', 'RegExp', 'Object', 'Function', 'Boolean', 'Error', 'Symbol', 'Set', 'Map', 'WeakSet', 'WeakMap', 'Proxy', 'Reflect', 'JSON', 'Promise', 'Float64Array', 'Int16Array', 'Int32Array', 'Int8Array', 'Uint16Array', 'Uint32Array', 'Float32Array', 'Array', 'Uint8Array', 'Uint8ClampedArray', 'ArrayBuffer', 'BigInt64Array', 'BigUint64Array', 'BigInt'], ['EvalError', 'InternalError', 'RangeError', 'ReferenceError', 'SyntaxError', 'TypeError', 'URIError'])
  function t (e) { return r('(?=', e, ')') } function r (...e) {
    ...
    const c = {
    ...
    }; const o = { className: 'meta', begin: '@[A-Za-z$_][0-9A-Za-z$_]*' }; const l = (e, n, a) => {
      const s = e.contains.findIndex(e => e.label === n)
      if (s === -1) throw Error('can not find mode to replace'); e.contains.splice(s, 1, a)
    }; const b = (i => {
      const c = e; const o = {
        begin: /<[A-Za-z0-9\\._:-]+/,
        end: /\/[A-Za-z0-9\\._:-]+>|\/>/,
        isTrulyOpeningTag: (e, n) => {
          const a = e[0].length + e.index; const s = e.input[a]; s !== '<'
            ? s === '>' && (((e, { after: n }) => {
              const a = '</' + e[0].slice(1); return e.input.indexOf(a, n) !== -1
        ...
        literal: a,
        built_in: s
      }; const b = '\\.([0-9](_?[0-9])*)'; const d = '0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*'; const g = {
        className: 'number', variants: [{ begin: `(\\b(${d})((${b})|\\.)?|(${b}))[eE][+-]?([0-9](_?[0-9])*)\\b` }, { begin: `\\b(${d})\\b((${b})\\b|\\.)?|(${b})\\b` }, { begin: '\\b(0|[1-9](_?[0-9])*)n\\b' }, { begin: '\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b' }, { begin: '\\b0[bB][0-1](_?[0-1])*n?\\b' }, { begin: '\\b0[oO][0-7](_?[0-7])*n?\\b' }, { begin: '\\b0[0-7]+n?\\b' }], relevance: 0
      }; const u = {
        className: 'subst',
        begin: '\\$\\{',
        end: '\\}',
      ...
      }; const p = [i.APOS_STRING_MODE, i.QUOTE_STRING_MODE, E, m, y, g, i.REGEXP_MODE]
      u.contains = p.concat({ begin: /\{/, end: /\}/, keywords: l, contains: ['self'].concat(p) }); const N = [].concat(_, u.contains); const f = N.concat([{
        begin: /\(/,
        end: /\)/,
        keywords: l,
        ...
        contains: [i.SHEBANG({
          ...
          contains: [_, i.REGEXP_MODE, {
            ...
            contains: [{
              className: 'params', variants: [{ begin: i.UNDERSCORE_IDENT_RE, relevance: 0 }, { className: null, begin: /\(\s*\)/, skip: !0 }, { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: l, contains: f }]
            }]
          ...
          excludeEnd: !0,
          illegal: /[:"[\]]/,
          contains: [{ beginKeywords: 'extends' }, i.UNDERSCORE_TITLE_MODE]
        }, {
          begin: /\b(?=constructor)/,
          end: /[{;]/,
          excludeEnd: !0,
    ...
    return Object.assign(b.keywords, c), b.exports.PARAMS_CONTAINS.push(o), b.contains = b.contains.concat([o, { beginKeywords: 'namespace', end: /\{/, excludeEnd: !0 }, {
      ...
      relevance: 10,
      begin: /^\s*['"]use strict['"]/
    }), b.contains.find(e => e.className === 'function').relevance = 0, Object.assign(b, { name: 'TypeScript', aliases: ['ts', 'tsx'] }), b
  }
  ...
  function r (e) { return t('(?=', e, ')') } function t (...e) {
    ...
    const c = e; const o = {
      ...
      isTrulyOpeningTag: (e, n) => {
        const a = e[0].length + e.index; const s = e.input[a]
        s !== '<'
          ? s === '>' && (((e, { after: n }) => {
            const a = '</' + e[0].slice(1)
      ...
      literal: a,
      built_in: s
    }; const g = '\\.([0-9](_?[0-9])*)'; const b = '0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*'; const d = {
      className: 'number', variants: [{ begin: `(\\b(${b})((${g})|\\.)?|(${g}))[eE][+-]?([0-9](_?[0-9])*)\\b` }, { begin: `\\b(${b})\\b((${g})\\b|\\.)?|(${g})\\b` }, { begin: '\\b(0|[1-9](_?[0-9])*)n\\b' }, { begin: '\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b' }, { begin: '\\b0[bB][0-1](_?[0-1])*n?\\b' }, { begin: '\\b0[oO][0-7](_?[0-7])*n?\\b' }, { begin: '\\b0[0-7]+n?\\b' }], relevance: 0
    }; const E = {
      className: 'subst',
      begin: '\\$\\{',
      end: '\\}',
    ...
    E.contains = N.concat({ begin: /\{/, end: /\}/, keywords: l, contains: ['self'].concat(N) }); const A = [].concat(y, E.contains); const f = A.concat([{
      begin: /\(/,
      end: /\)/,
      keywords: l,
  ...
  'use strict'; return e => {
    ...
    }; const a = { className: 'meta', begin: /^(>>>|\.\.\.) / }; const i = {
      className: 'subst',
      begin: /\{/,
      end: /\}/,
      keywords: n,
      illegal: /#/
    }; const s = { begin: /\{\{/, relevance: 0 }; const t = {
      className: 'string',
      contains: [e.BACKSLASH_ESCAPE],
      variants: [{
        ...
        relevance: 10
      }, { begin: /([uU]|[rR])"/, end: /"/, relevance: 10 }, { begin: /([bB]|[bB][rR]|[rR][bB])'/, end: /'/ }, {
    ...
    }; const r = '[0-9](_?[0-9])*'; const l = `(\\b(${r}))?\\.(${r})|\\b(${r})\\.`; const b = {
      className: 'number', relevance: 0, variants: [{ begin: `(\\b(${r})|(${l}))[eE][+-]?(${r})[jJ]?\\b` }, { begin: `(${l})[jJ]?` }, { begin: '\\b([1-9](_?[0-9])*|0+(_?0)*)[lLjJ]?\\b' }, { begin: '\\b0[bB](_?[01])+[lL]?\\b' }, { begin: '\\b0[oO](_?[0-7])+[lL]?\\b' }, { begin: '\\b0[xX](_?[0-9a-fA-F])+[lL]?\\b' }, { begin: `\\b(${r})[jJ]\\b` }]
    }; const o = {
      className: 'comment',
      begin: (d = /# type:/, ((...e) => e.map(e => (e => e ? typeof e === 'string' ? e : e.source : null)(e)).join(''))('(?=', d, ')')),
      end: /$/,
      keywords: n,
      contains: [{ begin: /# type:/ }, {
        begin: /#/,
    ...
    return i.contains = [t, b, a], {
      ...
      keywords: n,
      illegal: /(<\/|->|\?)|=>/,
      contains: [a, b, { begin: /\bself\b/ }, { beginKeywords: 'if', relevance: 0 }, t, o, e.HASH_COMMENT_MODE, {
